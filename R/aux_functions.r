...
#' #' Internal function to updates value label information after recoding
#' #'
#' #' @keywords internal
#' #' @param obj object of class sdcMicroObj-class
#' #' @param var variable name (variable names cannot be changed during SDC process)
...
#'   updateValueLabelX(obj, var, before, after, lab)
#' }
#' setGeneric("updateValueLabelX", function(obj, var, before, after, lab) {
#'   standardGeneric("updateValueLabelX")
#' })
#' 
#' setMethod(f="updateValueLabelX", signature=c("sdcMicroObj"), definition=function(obj, var, before, after, lab){
#'   #updateValueLabel <- function(obj, var, before, after, lab){
