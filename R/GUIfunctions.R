...
# @param facVar variable of class factor with levels the numeric values in string format
# @param lab list with label information generated by extractLabels
# @return a vector of class labelled or the initial vector
...
extractLabels <- function(dat){
  ...
  if (!all(sapply(sapply(dat, function(x) { attr(x, "label") }), is.null))) {
    ...
    # Set NULL values in var.label to NA
